...
//---- Macro
IMPLEMENT_DYNAMIC(CSensorSetupDlg, CDialog)

//------------------------------------------------------------------------------
//Constructor
//------------------------------------------------------------------------------
CSensorSetupDlg::CSensorSetupDlg()
{ 
  pDev = NULL;
  status_old = 0x00;
  enabled = 0;
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSensorSetupDlg)
	...
	//----
	DDX_Control(pDX, IDC_EDIT_CALIBR, m_edit_calibr);
	...
	/*
	DDX_Control(pDX, IDC_STATIC_PIC_ALERT1, m_status_txt[0]);
	DDX_Control(pDX, IDC_STATIC_PIC_ALERT2, m_status_txt[1]);
	DDX_Control(pDX, IDC_STATIC_PIC_ALERT3, m_status_txt[2]);
	DDX_Control(pDX, IDC_STATIC_PIC_ALERT4, m_status_txt[3]);
	DDX_Control(pDX, IDC_STATIC_PIC_IR,  m_status_txt[4]);
	DDX_Control(pDX, IDC_STATIC_PIC_THU, m_status_txt[5]);
	DDX_Control(pDX, IDC_STATIC_PIC_BMC, m_status_txt[6]); */
...
//mesages
//------------------------------------------------------------------------------
BEGIN_MESSAGE_MAP(CSensorSetupDlg, CDialog)
  //{{AFX_MSG_MAP(CSensorSetupDlg)
  ON_WM_PAINT() 
  ON_WM_DESTROY()
  ON_WM_SYSCOMMAND()
  //ON_WM_CONTEXTMENU()
  ...
  //----
  ON_BN_CLICKED(IDC_BUTTON_SET_DEFAULT, &CSensorSetupDlg::OnButtonSetDefault)
  //----

  //----

  //----
  ON_CBN_SELCHANGE(IDC_COMBO_MODE, &CSensorSetupDlg::OnComboMode)
  ON_CBN_SELCHANGE(IDC_COMBO_TYPES, &CSensorSetupDlg::OnComboTypes)
  ON_CBN_SELCHANGE(IDC_COMBO_FILTER, &CSensorSetupDlg::OnComboFilter)
  ON_CBN_SELCHANGE(IDC_COMBO_BURST, &CSensorSetupDlg::OnComboBurst)
  ON_CBN_SELCHANGE(IDC_COMBO_MEASURE_RES, &CSensorSetupDlg::OnComboMeasureResolution)
  ON_CBN_SELCHANGE(IDC_COMBO_AMBIENT_RES, &CSensorSetupDlg::OnComboAmbientResolution)
...
//------------------------------------------------------------------------------
BOOL CSensorSetupDlg::OnInitDialog()
{
...
//Function:
//------------------------------------------------------------------------------
void CSensorSetupDlg::Controls_Ini(void)
{
  CString txt;
  //----
  //Ini all
  m_combo_sns_types.ResetContent();
  m_combo_sns_types.InsertString(0, "Type K");
  m_combo_sns_types.InsertString(1, "Type J");
  m_combo_sns_types.InsertString(2, "Type T");
  m_combo_sns_types.InsertString(3, "Type N");
  m_combo_sns_types.InsertString(4, "Type S");
  m_combo_sns_types.InsertString(5, "Type E");
  m_combo_sns_types.InsertString(6, "Type B");
  m_combo_sns_types.InsertString(7, "Type R");
  m_combo_sns_types.SetCurSel(pDev->TS[chn].sensor_type);
  ...
  //---- 
  txt.Format("%.2f", pDev->TS[chn].calibration);
  m_edit_calibr.SetWindowTextA(txt);
  m_edit_calibr.UpdateWindow();
...
//Function:
//------------------------------------------------------------------------------
void CSensorSetupDlg::Controls_Enable(BOOL on_off)
{
  //Combo`s
  ...
  //Edit controls
  m_edit_calibr.EnableWindow(on_off);
...
//Function:
//------------------------------------------------------------------------------
void CSensorSetupDlg::Controls_Update(void)
{  
  //Combo`s
...
//
//-----------------------------------------------------------------------------
void CSensorSetupDlg::OnWindowPosChanged(WINDOWPOS* lpwndpos)
{
...
//
//------------------------------------------------------------------------------
int CSensorSetupDlg::ParseValue(CEdit *pEdit, short min, int max)
{
  CString txt;
  int value;
  int result=0;
...
//
//------------------------------------------------------------------------------
int CSensorSetupDlg::ParseValueFl(CEdit *pEdit, float min, float max, float &ret)
{
  CString txt;
  float value;
  int result=0;
...
//Press OK
//------------------------------------------------------------------------------
BOOL CSensorSetupDlg::PreTranslateMessage(MSG* pMsg)
{
...
//Press Exit
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnBnClickedOk()
{
  OnCancel();
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::CloseDlg(void)
{
  CDialog::OnCancel();
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnButtonSetDefault()
{
  //Send cmd to main dlg
...
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboTypes()
{
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboFilter()
{
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboMeasureResolution()
{
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboAmbientResolution()
{
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboMode()
{
...
//
//------------------------------------------------------------------------------
void CSensorSetupDlg::OnComboBurst()
{
...
//
//-----------------------------------------------------------------------------
void CSensorSetupDlg::LED_Control(unsigned char status)
{ 
